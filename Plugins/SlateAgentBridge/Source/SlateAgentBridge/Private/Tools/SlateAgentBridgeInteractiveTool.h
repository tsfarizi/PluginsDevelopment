...
#include "SlateAgentBridgeInteractiveTool.generated.h"


/**
 * Builder for USlateAgentBridgeInteractiveTool
 */
UCLASS()
class SLATEAGENTBRIDGE_API USlateAgentBridgeInteractiveToolBuilder : public UInteractiveToolBuilder
{
	GENERATED_BODY()
...
/**
 * Property set for the USlateAgentBridgeInteractiveTool
 */
UCLASS(Transient)
class SLATEAGENTBRIDGE_API USlateAgentBridgeInteractiveToolProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()

public:
	USlateAgentBridgeInteractiveToolProperties();
...
/**
 * USlateAgentBridgeInteractiveTool is an example Tool that allows the user to measure the 
 ...
 */
UCLASS()
class SLATEAGENTBRIDGE_API USlateAgentBridgeInteractiveTool : public UInteractiveTool, public IClickDragBehaviorTarget
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY()
	TObjectPtr<USlateAgentBridgeInteractiveToolProperties> Properties;
