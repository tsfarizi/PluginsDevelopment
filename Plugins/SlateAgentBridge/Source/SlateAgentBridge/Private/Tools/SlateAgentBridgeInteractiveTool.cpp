...
#define LOCTEXT_NAMESPACE "USlateAgentBridgeInteractiveTool"

/*
 * ToolBuilder
 */

UInteractiveTool* USlateAgentBridgeInteractiveToolBuilder::BuildTool(const FToolBuilderState & SceneState) const
{
	USlateAgentBridgeInteractiveTool* NewTool = NewObject<USlateAgentBridgeInteractiveTool>(SceneState.ToolManager);
...
USlateAgentBridgeInteractiveToolProperties::USlateAgentBridgeInteractiveToolProperties()
{
...
void USlateAgentBridgeInteractiveTool::SetWorld(UWorld* World)
{
	check(World);
...
void USlateAgentBridgeInteractiveTool::Setup()
{
	...
	Properties = NewObject<USlateAgentBridgeInteractiveToolProperties>(this, "Measurement");
...
void USlateAgentBridgeInteractiveTool::OnUpdateModifierState(int ModifierID, bool bIsOn)
{
...
FInputRayHit USlateAgentBridgeInteractiveTool::CanBeginClickDragSequence(const FInputDeviceRay& PressPos)
{
...
void USlateAgentBridgeInteractiveTool::OnClickPress(const FInputDeviceRay& PressPos)
{
...
void USlateAgentBridgeInteractiveTool::OnClickDrag(const FInputDeviceRay& DragPos)
{
	UpdatePosition(DragPos.WorldRay);
}


FInputRayHit USlateAgentBridgeInteractiveTool::FindRayHit(const FRay& WorldRay, FVector& HitPos)
{
...
void USlateAgentBridgeInteractiveTool::UpdatePosition(const FRay& WorldRay)
{
...
void USlateAgentBridgeInteractiveTool::UpdateDistance()
{
	Properties->Distance = FVector::Distance(Properties->StartPoint, Properties->EndPoint);
}


void USlateAgentBridgeInteractiveTool::OnPropertyModified(UObject* PropertySet, FProperty* Property)
{
...
void USlateAgentBridgeInteractiveTool::Render(IToolsContextRenderAPI* RenderAPI)
{
