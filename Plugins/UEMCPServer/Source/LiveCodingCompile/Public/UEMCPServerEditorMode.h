...
#include "UEMCPServerEditorMode.generated.h"
 ...
 */
UCLASS()
class UUEMCPServerEditorMode : public UEdMode
{
	GENERATED_BODY()

public:
	const static FEditorModeID EM_UEMCPServerEditorModeId;

	static FString SimpleToolName;
	static FString InteractiveToolName;

	UUEMCPServerEditorMode();
	virtual ~UUEMCPServerEditorMode();
