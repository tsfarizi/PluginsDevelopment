...
#include "UEMCPServerInteractiveTool.h"
...
#define LOCTEXT_NAMESPACE "UUEMCPServerInteractiveTool"

/*
 * ToolBuilder
 */

UInteractiveTool* UUEMCPServerInteractiveToolBuilder::BuildTool(const FToolBuilderState & SceneState) const
{
	UUEMCPServerInteractiveTool* NewTool = NewObject<UUEMCPServerInteractiveTool>(SceneState.ToolManager);
...
UUEMCPServerInteractiveToolProperties::UUEMCPServerInteractiveToolProperties()
{
...
void UUEMCPServerInteractiveTool::SetWorld(UWorld* World)
{
	check(World);
...
void UUEMCPServerInteractiveTool::Setup()
{
	...
	Properties = NewObject<UUEMCPServerInteractiveToolProperties>(this, "Measurement");
...
void UUEMCPServerInteractiveTool::OnUpdateModifierState(int ModifierID, bool bIsOn)
{
...
FInputRayHit UUEMCPServerInteractiveTool::CanBeginClickDragSequence(const FInputDeviceRay& PressPos)
{
...
void UUEMCPServerInteractiveTool::OnClickPress(const FInputDeviceRay& PressPos)
{
...
void UUEMCPServerInteractiveTool::OnClickDrag(const FInputDeviceRay& DragPos)
{
	UpdatePosition(DragPos.WorldRay);
}


FInputRayHit UUEMCPServerInteractiveTool::FindRayHit(const FRay& WorldRay, FVector& HitPos)
{
...
void UUEMCPServerInteractiveTool::UpdatePosition(const FRay& WorldRay)
{
...
void UUEMCPServerInteractiveTool::UpdateDistance()
{
	Properties->Distance = FVector::Distance(Properties->StartPoint, Properties->EndPoint);
}


void UUEMCPServerInteractiveTool::OnPropertyModified(UObject* PropertySet, FProperty* Property)
{
...
void UUEMCPServerInteractiveTool::Render(IToolsContextRenderAPI* RenderAPI)
{
