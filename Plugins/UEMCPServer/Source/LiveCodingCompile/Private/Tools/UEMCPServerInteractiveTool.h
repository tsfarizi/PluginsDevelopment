...
#include "UEMCPServerInteractiveTool.generated.h"
...
public:
	UUEMCPServerInteractiveToolProperties();
...
/**
 * UUEMCPServerInteractiveTool is an example Tool that allows the user to measure the 
...
protected:
	...
	UPROPERTY()
	TObjectPtr<UUEMCPServerInteractiveToolProperties> Properties;
